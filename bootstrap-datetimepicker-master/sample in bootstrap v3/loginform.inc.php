                                ...
                                <div class="menu_wrap">
                                    <ul class="nav sf-menu">
                                      ...
                                      <li class="sub-menu"><a href="javascript:{}">Account</a>
                                           <ul>
                                              <li><a href="#" onclick="document.getElementById('id01').style.display='block' "><span>-</span>Login</a></li>
                                              <li><a href="Edit form/view.<?php  ?>"><span>-</span>My account</a></li>
                                              <li><a href="logout.php"><span>-</span>Logout</a></li>
                                              <li><a href="#" onclick="document.getElementById('id02').style.display='block'" ><span>-</span>Signup</a></a></li> 
                                          </ul>
                                      </li>                                  
                                    </ul>
                                </div>
