...
/*    
    ...
    $seconds  = $time2-$time1;
    echo "day is : ".$days    = floor($seconds / 86400);
    echo "<br>";
    echo "hour is : ".$hours   = floor(($seconds - ($days * 86400)) / 3600);
    echo "<br>";
    echo "minute is : ".$minutes = floor(($seconds - ($days * 86400) - ($hours * 3600))/60);
    echo "<br>";
    echo "second  is : ".$seconds = floor(($seconds - ($days * 86400) - ($hours * 3600) - ($minutes*60)));
    echo "<br>";
 */   
/**************************************************************************************************************** 
 *                                                                                                              * 
